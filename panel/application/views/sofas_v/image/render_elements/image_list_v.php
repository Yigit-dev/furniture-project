...
<table class="table table-bordered table-striped table-hover pictures_list">
    ...
    <tbody class="sortable" data-url="<?php echo base_url("sofas/imageRankSetter"); ?>">
    ...
    <?php foreach($item_images as $image){ ?>
        ...
        <tr id="ord-<?php echo $image->id; ?>">
            ...
            <td class="w100 text-center">
                <input
                    data-url="<?php echo base_url("sofas/imageIsActiveSetter/$image->id"); ?>"
                    class="isActive"
                    type="checkbox"
                    data-switchery
                    data-color="#10c469"
            ...
            <td class="w100 text-center">
                <input
                    data-url="<?php echo base_url("sofas/isCoverSetter/$image->id/$image->sofas_id"); ?>"
                    class="isCover"
                    type="checkbox"
                    data-switchery
                    data-color="#ff5b5b"
            ...
            <td class="w100 text-center">
                <button
                    data-url="<?php echo base_url("sofas/imageDelete/$image->id/$image->sofas_id"); ?>"
