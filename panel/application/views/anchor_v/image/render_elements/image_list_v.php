...
<table class="table table-bordered table-striped table-hover pictures_list">
    ...
    <tbody class="sortable" data-url="<?php echo base_url("anchor/imageRankSetter"); ?>">
    ...
    <?php foreach($item_images as $image){ ?>
        ...
        <tr id="ord-<?php echo $image->id; ?>">
            ...
            <td class="w100 text-center">
                <input
                    data-url="<?php echo base_url("anchor/imageIsActiveSetter/$image->id"); ?>"
                    class="isActive"
                    type="checkbox"
                    data-switchery
                    data-color="#10c469"
            ...
            <td class="w100 text-center">
                <input
                    data-url="<?php echo base_url("anchor/isCoverSetter/$image->id/$image->anchor_id"); ?>"
                    class="isCover"
                    type="checkbox"
                    data-switchery
                    data-color="#ff5b5b"
            ...
            <td class="w100 text-center">
                <button
                    data-url="<?php echo base_url("anchor/imageDelete/$image->id/$image->anchor_id"); ?>"
